...
exports.logout = exports.getUserByCookie = exports.updateID = exports.addUser = exports.login = void 0;
...
function login(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, emailLogin, passwordLogin, userDB, isMatch, cookie, secret, JWTCookie, error_1;
...
function addUser(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, password, email, firstName, lastName, repeatPassword, error, salt, hash, usersDB, error_2;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    _a = req.body, password = _a.password, email = _a.email, firstName = _a.firstName, lastName = _a.lastName, repeatPassword = _a.repeatPassword;
                    ...
                    return [4 /*yield*/, userModel_1["default"].create({ email: email, password: hash, firstName: firstName, lastName: lastName })];
                case 1:
                    usersDB = _b.sent();
                    if (!usersDB)
                ...
                case 2:
                    error_2 = _b.sent();
                    res.status(500).send({ success: false, error: error_2.message });
                    return [3 /*break*/, 3];
...
function getUserByCookie(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var userID, secret, decodedUserId, userId, userDB, error_4;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    res.send({ login: true, userDB: userDB, userId: userId });
                    return [3 /*break*/, 3];
                case 2:
                    error_4 = _a.sent();
