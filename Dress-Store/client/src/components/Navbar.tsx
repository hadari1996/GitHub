  ...
  return (
    <>
      <nav className="navbar">
        <ul>
          <li>
            <Link to={"/dresses-store"}>Store</Link>
          </li>
          <li>
            <Link to={"/dresses-store"}>
              <svg
          ...
          {user?.role === 1 ? (
            <li>
              {" "}
              <Link to={"/admin/add-dress"}>Add dress</Link>
            </li>
          ) : null}
          ...
          {user?.role === 1 ? (
            <li>
              {" "}
              <Link to={"/admin/update-dress"}>Update dress</Link>
            </li>
          ...
          {user?.role === 1 ? (
            <li>
              {" "}
              <Link to={"/admin/delete-dress"}>Delete dress</Link>
            </li>
